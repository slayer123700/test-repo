...
from ERISMUSIC.utils.Shukla_ban import admin_filter
...
import asyncio
import time
from ERISMUSIC.utils.database import add_served_chat
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton
from ERISMUSIC.utils.database import get_assistant
import asyncio
from ERISMUSIC.misc import SUDOERS
from ERISMUSIC.mongo.afkdb import PROCESS
from pyrogram import Client, filters
...
from ERISMUSIC.utils.database import get_assistant, is_active_chat
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("ERISMUSIC/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((500, 500))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('ERISMUSIC/assets/font.ttf', size=60)
    welcome_font = ImageFont.truetype('ERISMUSIC/assets/font.ttf', size=60)

...
from ERISMUSIC.misc import _boot_
from ERISMUSIC.plugins.sudo.sudoers import sudoers_list
from ERISMUSIC.utils.database import get_served_chats, get_served_users, get_sudoers
...
from ERISMUSIC.utils.decorators.language import LanguageStart
from ERISMUSIC.utils.formatters import get_readable_time
from ERISMUSIC.utils.inline import help_pannel, private_panel, start_panel
...
YUMI_PICS = [
"https://files.catbox.moe/boqmdc.mp4",
